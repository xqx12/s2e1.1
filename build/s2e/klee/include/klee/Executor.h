...
public:
  ...
  //addbyxqx201303
  void xgdb_printState(ExecutionState &state, bool fullMO = false);
  void xgdb_printState(std::ostream &ostrm, ExecutionState &state, bool fullMO = false);
  std::ostream& getKleeInfoStream() const {
	  return *m_kleeInfoFile;
  }
