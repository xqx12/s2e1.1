...
S2E_DEFINE_PLUGIN(Disassembler, "Disassembler S2E plugin", "Disassembler",);
...
void Disassembler::initialize()
{
    ...
    //        sigc::mem_fun(*this, &Disassembler::slotTranslateBlockStart));
}

/*
void Disassembler::slotTranslateBlockStart(ExecutionSignal *signal, 
                                      ...
                                      uint64_t pc)
{
    ...
    if(m_traceBlockExecution)
        signal->connect(sigc::mem_fun(*this, &Disassembler::slotExecuteBlockStart));
}

void Disassembler::slotExecuteBlockStart(S2EExecutionState *state, uint64_t pc)
{
...
unsigned char* Disassembler::Disassemble(unsigned int LinearAddress, unsigned char *Code, PINSTRUCTION Instruction, char *InstructionStr, int &bPrint)
{
...
unsigned char* Disassembler::ParseRegModRM(unsigned char *Code, PINSTRUCTION Instruction, char *Operand1, char *Operand2)
{
	unsigned char *currentCode;
	char RegOpcode;
...
unsigned char* Disassembler::ParseSIB(unsigned char *Code, PINSTRUCTION Instruction, char *SIBStr)
{
	char *currentCode;
	char Mod;
...
unsigned char* Disassembler::ParseModRM(unsigned char *Code, PINSTRUCTION Instruction, char *OperandRM)
{
	unsigned char *currentCode;
	char Mod, RM;
	char DisplacementStr[MAX_OPERAND_LEN] = "";
...
unsigned char* Disassembler::ParseImmediate(unsigned char *Code, PINSTRUCTION Instruction, char *OperandImmediate)
{
	unsigned char *currentCode;
